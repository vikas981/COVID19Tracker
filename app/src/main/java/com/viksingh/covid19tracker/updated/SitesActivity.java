...
public class SitesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle((CharSequence) "Vaccination Sites");
        Init();
        fetchData();
    ...
    public void fetchData(){
        ...
        requestQueue.add(new JsonObjectRequest(0, String.format("https://api.cowin.gov.in/api/v1/reports/v2/getPublicReports?state_id=&district_id=&date=%s",today), (JSONObject) null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject object = response.getJSONObject("topBlock").getJSONObject("sites");
                    ...
                    System.out.println("8888888->"+today);
                    ...
                    new Handler().postDelayed(new Runnable() {
                       @Override
                       public void run() {
                          SitesActivity.this.total.setText(CommonUtil.getFormatedNumber(total));
                          SitesActivity.this.govt.setText(CommonUtil.getFormatedNumber(govt));
                          SitesActivity.this.pvt.setText(CommonUtil.getFormatedNumber(pvt));
                          SitesActivity.this.today.setText(finalToday);
                          SitesActivity.this.last_update.setText(last_update);
    ...
    public void Init(){
        ...
        pvt=findViewById(R.id.pvt);
        today=findViewById(R.id.today);
        last_update=findViewById(R.id.last_update);
        pieChart =findViewById(R.id.site_piechart);
    }
